        ...
        <div class="nav">
            ...
            <?php
                    ...
                    if (isset($_SESSION["loginId"])) {
                        ...
                        $stmt = "select * from tblAuftraege where idKunde = ".$_SESSION['loginId']."";
                        ...
                        echo("<table>");
                        echo("<tr>");
                        echo("<th>ID-Auftrag</th>");
                        echo("<th>Auftragsbeschreibung</th>");
                        echo("<th>ID-Kunde</th>");
                        echo("</tr>");
                        while($row = oci_fetch_array($parsed_stmt, OCI_BOTH)) {
                            echo("<tr>");
                            echo("<td>".$row['IDAUFTRAG']."</td>");
                            echo("<td>".$row['AUFTRAGSBESCHREIBUNG']."</td>");
